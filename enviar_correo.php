...
if (mail($correoCorporativo, $asunto, $cuerpoMensaje, $headers)) {
    echo '<p>El mensaje se ha enviado correctamente al correo corporativo.</p>';
} else {
...
if (!empty($correoRemitente)) {
    if (mail($correoRemitente, $asunto, $cuerpoMensaje, $headers)) {
        echo '<p>Una copia del mensaje se ha enviado correctamente a tu correo electrónico.</p>';
    } else {
